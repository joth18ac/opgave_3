...
/**
 * I render metoden, skal der være tekst om prøvepakke 3.
 * Kan komme tilbage til oversigten over prøvepakker, via en OnPress metode.
 */


export default class SamplePackageScreen3 extends Component {
    ...
    render(){
        return (
            <View style={styles.container}>
                ...
                <Text style={styles.text}>Prøvepakke 3:</Text>
                ...
                <Button style= {styles.btn} title="Take me there!" onPress={this.handleGoToSamplePackageOverview} />
                </View>
            </View>
