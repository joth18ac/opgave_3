...
/**
 * I render metoden, skal der være tekst om prøvepakke 1.
 * Kan komme tilbage til oversigten over prøvepakker, via en OnPress metode.
 */

export default class SamplePackageScreen1 extends Component {
    ...
    render(){
        return (
            <View style={styles.container}>
                <Text style={styles.text}>Prøvepakke 1:</Text>
